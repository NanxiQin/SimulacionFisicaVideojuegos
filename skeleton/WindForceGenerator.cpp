...
WindForceGenerator::WindForceGenerator(double k1, Vector3 windVel, double duration ) :ForceGenerator(WindForce,duration), windVel(windVel),k1(k1),airDensity(1.2),dragCoef(0.5),k2(0.1){}
