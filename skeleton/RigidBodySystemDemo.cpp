#include "RigidBodySystemDemo.h"

extern PxPhysics* gPhysics;
extern PxScene* gScene;

RigidBodySystemDemo::RigidBodySystemDemo(Scene* scene, const Vector3& g) :RigidBodySystem(scene, g)
{
	rigidBodyDemo();
}

void RigidBodySystemDemo::update(double t)
{
...
void RigidBodySystemDemo::keyPress(unsigned char key)
{
	switch (key) {
	case add_Uniwind:
...
void RigidBodySystemDemo::resetSystem()
{
	ParticleSystem::resetSystem();
	rigidBodyDemo();
}

void RigidBodySystemDemo::rigidBodyDemo()
{
	//punto de mira
