...
{
public:
	DynamicRigidBody(ParticleProperties prop, bool registerRendering=true,PxMaterial* material=nullptr, GeometryType geometryType = PxGeometryType::eSPHERE,Vector3 volume=Vector3(0), Vector3 tensor = Vector3(-1), PxFilterData* filter=nullptr);
	void die() override;
